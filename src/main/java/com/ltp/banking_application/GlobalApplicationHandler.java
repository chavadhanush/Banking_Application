package com.ltp.banking_application;
...
import com.ltp.banking_application.exception.ErrorResponse;

import java.util.Arrays;

@ControllerAdvice
public class GlobalApplicationHandler extends ResponseEntityExceptionHandler {
